...
ifdef PSDK_REAL
  CFLAGS += \
      ...
      -DBUILD_DRONE_MODEL=\"$(DRONE_MODEL)\" \
      -DBUILD_CONN_MODE=\"$(DRONE_CONN_NAME)\" \
      -DBUILD_PLATFORM=\"$(if $(PLATFORM),$(PLATFORM),unknown)\" \
